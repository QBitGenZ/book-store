              ...
              {item.children ? (
                <>
                  <div
                    ...
                    style={{
                      borderColor: isActive(item.path) ? shop?.accentColor : 'transparent',
                      ...
                      {item.children.map((child) => (
                        ...
                        >
                          <Link 
                            ...
                            style={{
                              borderColor: isActive(child.path) ? shop?.accentColor : 'transparent',
                              color: isActive(child.path) ? shop?.accentColor : hoveredItem === child.key ? shop?.neutralColor : shop?.primaryColor,
                            }}
                          >
                            {child.label}
                          </Link>
                ...
                <Link 
                  ...
                  style={{
                    borderColor: isActive(item.path) ? shop?.accentColor : 'transparent',
                    color: isActive(item.path) ? shop?.accentColor : hoveredItem === item.key ? shop?.neutralColor : shop?.primaryColor,
                  }}
                >
                  {item.label}
                </Link>
