...
const BasicInfo = ({ shop, }) => {
  ...
  const [imageSource, setImageSource,] = React.useState(`${process.env.REACT_APP_HOST_IP}/${shop?.logo}` || null);
  ...
  return ( <div className='flex flex-col gap-3'>
    <div className='rounded-xl p-3 bg-white w-full'>
      ...
      <div className='text-left mt-4'>
        <Button variant='contained' onClick={handleSavePublicInfo}>{translate('save')}</Button>
      </div>
    </div>
    <div className='rounded-xl p-3 bg-white w-full'>
