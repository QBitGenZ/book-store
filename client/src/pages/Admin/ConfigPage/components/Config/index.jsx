...
const Config = ({ shop, }) => {
  ...
  const [primaryBackground, setPrimaryBackground,] = React.useState(
    shop?.primaryBackground
  );
  const [secondaryBackground, setSecondaryBackground,] = React.useState(
    shop?.secondaryBackground
  );
  const [accentBackground, setAccentBackground,] = React.useState(
    shop?.accentBackground
  );
  const [neutralBackground, setNeutralBackground,] = React.useState(
    shop?.neutralBackground
  );
        ...
        <div className='flex justify-between'>
          ...
          <div className='w-fit'>
            <ColorSelector
              ...
              setValue={setSecondaryBackground}
            />
          ...
          <div className='w-fit'>
            <ColorSelector
              ...
              setValue={setAccentBackground}
            />
            <div>{translate('accent-background')}</div>
          </div>
          <div className='w-fit'>
            <ColorSelector
              value={neutralBackground}
              setValue={setNeutralBackground}
            />
