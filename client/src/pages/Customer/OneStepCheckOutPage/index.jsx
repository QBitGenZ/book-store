  ...
  const handleUpdateAddress = (updatedAddress) => {
    ...
    setConfirmConfig({
      ...
      action: () => {
        ...
        setModals(prev => ({
          ...prev, updateAddress: false, confirm: false,
        }));
      },
    });
    setModals(prev => ({
  ...
  return (
    <>
      ...
      <AddNewAddressModal
        ...
        setShow={(show) => setModals(prev => ({
          ...prev, newAddress: show,
        }))}
              ...
              <div key={address._id || index}
                ...
                <div className='flex items-center flex-1'>
                  <input
                    ...
                    className='mr-2'
                    style={{
                      accentColor: selectedAddress?._id === address._id ? shop?.accentColor : '#999',
                    }}
                  />
