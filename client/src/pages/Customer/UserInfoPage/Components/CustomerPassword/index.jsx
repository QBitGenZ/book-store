        ...
        <div>
          <div className='flex justify-between mb-4'>
            <div className='flex flex-col gap-3 w-1/2'>
              <TextField type='password' value={oldPwd} onChange={e => setOldPwd(e.target.value)}
                size='small' placeholder={translate('old-password')}
                label={translate('old-password')}/>
              <TextField type='password' value={newPwd} onChange={e => setNewPwd(e.target.value)}
                size='small' placeholder={translate('new-password')}
                label={translate('new-password')}/>
              <TextField type='password' value={confirmNewPwd}
                onChange={e => setConfirmNewPwd(e.target.value)} size='small'
